---
name: evaluate
description: Evaluate model performance and generate reports. Use when the user says "evaluate model", "evaluate", "model performance", "check metrics", or wants to assess how well a model performs.
---
