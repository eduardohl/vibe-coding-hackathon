---
name: create-pr
description: Create a pull request for the current changes. Use when the user says "create pr", "pull request", "create a PR", "push and create PR", or wants to submit code for review.
---
