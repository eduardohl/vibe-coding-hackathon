...
description: Automatically check data quality when writing to Delta tables. Use when the user mentions "data quality", "DQ", "null check", "missing values", "schema validation", "validate the table", or "check the output".
---
...
### Issues Found
- Warning: Column X has 5% null values
