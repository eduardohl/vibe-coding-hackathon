...
description: Creates mock grocery data for demo purposes via Databricks MCP. Use when the user says "setup demo data", "create mock data", "populate demo tables", or "initialize demo tables".
---
